...
class DataAPI(Resource):
    ...
    def post(self):
        ...
        parser.add_argument("admission_rate", type=float)
        parser.add_argument("average_sat", type=int)
        parser.add_argument("address", type=str)
        parser.add_argument("tuition_in_state", type=float)
        parser.add_argument("tuition_out_of_state", type=float)
